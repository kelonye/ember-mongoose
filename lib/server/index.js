...
Api.prototype.setPaths = function(paths) {
  ...
  paths.forEach(function(path){
    if (!_paths[path]){
      var e = that.model.modelName + ' has no path named ' + path;
      throw new Error(e);
    }
  });
...
Api.prototype.all = function(req, res) {
  ...
  if (req.query){
    ...
    fields = null; // this.pathsString;
    options = req.query.options;
  }
  that.model.find(conditions, fields, options, function(err, items) {
...
Api.prototype.create = function(req, res) {
  ...
  var that = this;
  var item = new that.model(req.body[that.singularName]);
