...
Api.prototype.getURIS = function(app) {
  ...
  app.delete('/' + this.pluralName + '/:id', this.remove.bind(this));
  return app;
};
...
Api.prototype.all = function(req, res, next) {
  ...
  if (req.query){
    ...
    if (req.query.options){
      ...
      if (req.query.options.count) return this.count.apply(this, arguments);
    }
  }
...
Api.prototype.count = function(req, res, next) {
  ...
  self
    .model
    .find(req.body.query.conditions, null, null)
